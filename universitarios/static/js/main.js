...
var CLASS_MENU_hidden = "menu-hidden";
//----------------------------------------------------------
...
function retrairMenu ()
{
    ...
    $('body').addClass(CLASS_MENU_hidden);
    ...
    $("#header .menu-module .menu-moduleInner").stop(true,true).animate({paddingLeft:0},_timer);
    $("#content .content-inner").stop(true,true).animate({paddingLeft:0},_timer);
...
function resizeWindow ()
{
    ...
    {
        if($('body').hasClass(CLASS_MENU_hidden))
        {
